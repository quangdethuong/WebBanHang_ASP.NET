...
using Project.Services.ShoppingCartAPI.Service.IService;

namespace Project.Services.ShoppingCartAPI.Controllers
{
    [Route("api/cart")]
    [ApiController]
    public class CartAPIController : ControllerBase
    {
        ...
        private readonly ICouponSerivce _couponService;
        private readonly IConfiguration _configuration;
        private readonly IMessageBus _messageBus;
        private readonly AppDbContext _db;
        public CartAPIController(AppDbContext db, IMapper mapper, IProductSerivce productSerivce, ICouponSerivce couponService, IMessageBus messageBus, IConfiguration configuration)
        {
            _db = db;
        ...
        public async Task<ResponseDto> RemoveCart([FromBody]int cartDetailsId)
        {
            try
            {
                CartDetail cartDetail = _db.CartDetails.First(x => x.CartDetailsId == cartDetailsId);

                int totalCountOfCartItem = _db.CartDetails.Where(x => x.CartHeaderId == cartDetail.CartHeaderId).Count();
