...
using Project.Services.ShoppingCartAPI;
using Project.Services.ShoppingCartAPI.Data;
using Project.Services.ShoppingCartAPI.Extensions;
using Project.Services.ShoppingCartAPI.Service;
using Project.Services.ShoppingCartAPI.Service.IService;
using Project.Services.ShoppingCartAPI.Utility;
...
builder.Services.AddScoped<ICouponSerivce, CouponService>();
